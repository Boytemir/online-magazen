          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                ...
                <a href="tel:+998906872001" className="mt-3 d-block mb-1 text-white">+998 90 687 20 01</a>
                <a href="mailto:boytemirxayitmurodov@gmail.com" className="mt-4 d-block mb-0 text-white">boytemirxayitmurodov@gmail</a>
                <div className="social_icons d-flex align-items-center mt-4 gap-30">
            ...
            <div className="col-3">
              ...
              <div className='footer-links d-flex flex-column'>
                <Link className="text-white py-2 mb-1">About Uz</Link>
